function plotObj = plotProfiles(uLabSpace, xLabSpace, tLabSpace, plotTime, linesToPlot, varargin)
% Function for plotting concentration profiles generated by modl3
% Three first input correspond to modl3 output
% vector plotTime is lab time for which you want to plot - not
% physicaltime!
...
lineColors = linspecer(4); % in help-functions
...
xlabel('Distance [m]')
h = legend(plotObj(1:length(linesToPlot)));
set(h,'FontSize',10)
